...
A zero-knowledge file storage system with client-side encryption. Files are encrypted before upload, ensuring the server never has access to plaintext data.
